...
public class ComentarioServicioController {
    ...
    @Operation(summary = "Eliminar todos los comentarios de servicio de un usuario (uso interno entre microservicios)")
    ...
    public ResponseEntity<Void> eliminarPorUsuario(@PathVariable Long idUsuario) {
        comentarioServicioService.eliminarPorUsuario(idUsuario);
        return ResponseEntity.noContent().build();
    }
