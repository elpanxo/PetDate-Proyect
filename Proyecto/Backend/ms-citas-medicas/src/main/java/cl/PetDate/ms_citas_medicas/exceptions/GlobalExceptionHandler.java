...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, String>> handleCitaNotFound(CitaMedicaNotFoundException ex) {
    ...
    public ResponseEntity<Map<String, String>> handleMascotaNotFound(MascotaNotFoundException ex) {
        return ResponseEntity.status(HttpStatus.NOT_FOUND)
                .body(Map.of("error", ex.getMessage()));
    }
